...
` 
    ...
    `;
     ...
     botaoTodos.onclick = ()=>  {
         usarFiltro("https://botafogo-atletas.mange.li/2024-1/all")
        }
        ...
        botaoFem.onclick = ()=>  {
            usarFiltro("https://botafogo-atletas.mange.li/2024-1/feminino")
        }
        ...
        botaoMas.onclick = ()=>  {
            usarFiltro("https://botafogo-atletas.mange.li/2024-1/masculino")
        }
    ...
    const montaCard = (entrada) => {
        ...
        inputPesquisa.onkeyup = (ev) => {
            ...
            if (ev.target.value.length > 1){
                ...
                conteudo.innerHTML = "";
                dados.forEach((atleta)=>(conteudo.appendChild(montaCard(atleta))
                        )
                    )
                    }
                }
